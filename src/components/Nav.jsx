...
export default function Nav() {
  return (
    <ul class="navigation" style={{ height: "300px", overflow: "auto" }}>
      <li value="0">
        <Link to="/">Home</Link>
      </li>
      <li type="I">
        ...
        <ul>
            ...
            <ul>
              ...
              <li type="1">
                <Link to="/facts/genocidal_acts/expulsion">
                  Mass expulsion from homes and displacement of Palestinians in
                  Gaza
                </Link>
              ...
              <li type="1">
                <Link to="/facts/genocidal_acts/medical">
                  Deprivation of adequate medical assistance to Palestinians in
                  Gaza
                </Link>
          ...
          <li type="A">
            <Link to="/facts/expressions_of_genocide">
              Expressions of Genocidal Intent against the Palestinian People by
